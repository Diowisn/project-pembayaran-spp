                    ...
                    <div class="col-md-3">
                        <div class="card bg-primary text-white mb-3">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <small class="text-white-50">Gunakan nomor ini untuk pembayaran via transfer bank</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card bg-success text-white mb-3">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <p class="card-text mb-1">SPP Bulan Ini:</p>
                                        <h4 class="mb-0">Rp {{ number_format($siswa->spp->nominal_spp ?? 0, 0, ',', '.') }}</h4>
                                    </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    {{-- <a href="#" class="btn btn-outline-light btn-sm ml-2">Cara Pembayaran</a> --}}
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="mb-0">Rp {{ number_format($sisaPembayaranInfaq, 0, ',', '.') }}</h4>
                                    </div>
                                </div>
                                ...
                                <div class="mt-2">
                                    <a href="{{ url('dashboard/siswa/infaq') }}" class="btn btn-light btn-sm">Detail Infaq</a>
            ...
            <div class="card-body">
                ...
                @else
                    <div class="alert alert-warning">
                        ...
                        <p>Total yang harus dibayarkan: Rp {{ number_format($siswa->spp->nominal_spp ?? 0, 0, ',', '.') }}</p>
                    </div>
                @endif
            </div>
        </div>
                        ...
                        <div class="info-box bg-gradient-success">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="progress-description">
                                    {{ round($persentaseTabungan, 2) }}% dari target Rp {{ number_format($targetTabungan, 0, ',', '.') }}
                                </span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="comment-text active w-100">
                                ...
                                <span class="m-b-15 d-block">
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">Jumlah Bayar: Rp {{ number_format($pembayaran->jumlah_bayar, 0, ',', '.') }}</li>
                                    </ul>
                                </span>
                                <div class="comment-footer">
                                    ...
                                    <span class="action-icons active" style="background-color: #4CAF50;">
                                        <a href="{{ route('siswa.pembayaran.cetak', $pembayaran->id) }}" class="mr-2"
                    ...
                    @foreach($infaqTerakhir as $infaq)
                        <div class="d-flex flex-row comment-row">
                            ...
                            <div class="comment-text active w-100">
                                ...
                                <span class="m-b-15 d-block">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Paket: <b class="text-uppercase">{{ $infaq->infaqGedung->paket ?? '-' }}</b></li>
                                        <li class="list-group-item">Angsuran Ke-{{ $infaq->angsuran_ke }}</li>
                                        <li class="list-group-item">Jumlah Bayar: Rp {{ number_format($infaq->jumlah_bayar, 0, ',', '.') }}</li>
                                        @php
                                            $totalDibayar = $infaq->siswa->angsuranInfaq->sum('jumlah_bayar');
                                            $sisaPembayaran = $infaq->infaqGedung->nominal - $totalDibayar;
                                        @endphp
                                        <li class="list-group-item">Total Dibayar: Rp {{ number_format($totalDibayar, 0, ',', '.') }}</li>
                                        <li class="list-group-item">Sisa Pembayaran: Rp {{ number_format($sisaPembayaran, 0, ',', '.') }}</li>
                                    </ul>
                                </span>
                                <div class="comment-footer">
                                    <span class="text-muted float-right">
                            ...
                            <tbody>
                                @foreach($tabungan as $transaksi)
                                    <tr>
                                        ...
                                        <td class="text-success">@if($transaksi->debit > 0) Rp {{ number_format($transaksi->debit, 0, ',', '.') }} @endif</td>
                                        <td class="text-danger">@if($transaksi->kredit > 0) Rp {{ number_format($transaksi->kredit, 0, ',', '.') }} @endif</td>
