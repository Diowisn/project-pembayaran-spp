...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Histori Uang Kegiatan Tahunan</li>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div style="background: #fff; border-radius: 15px; box-shadow: 0 0 20px rgba(0,0,0,0.05); margin-bottom: 30px;">
                ...
                <div style="background: linear-gradient(135deg, #4e73df 0%, #224abe 100%); padding: 25px; border-radius: 15px 15px 0 0; color: white;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            <h4 style="margin: 0; font-size: 20px; font-weight: 600;">
                                <i class="fas fa-calendar-alt mr-2"></i>Histori Uang Kegiatan Tahunan Saya
                            </h4>
                            <p style="margin: 5px 0 0 0; opacity: 0.8; font-size: 14px;">
                                Ringkasan transaksi uang kegiatan tahunan Anda
                            </p>
                        </div>
                        <div style="text-align: right;">
                            <div style="background: rgba(255,255,255,0.1); padding: 12px 20px; border-radius: 10px;">
                                ...
                                <h4 style="margin: 5px 0 0 0; font-size: 24px;">
                                    <i class="fas fa-wallet mr-2"></i>Rp {{ number_format($saldo, 0, ',', '.') }}
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 20px; display: flex; gap: 10px;">
                        <a href="{{ route('siswa.uang-tahunan.cetak') }}" 
                        ...
                        <table class="table" style="margin: 0;">
                            <thead>
                                <tr style="background: #f8f9fc; border-radius: 8px;">
                                    <th style="padding: 15px; border-top: none; color: #4e73df; font-weight: 600;">
                                    ...
                                    <th style="padding: 15px; border-top: none; color: #4e73df; font-weight: 600;">
                                        <i class="fas fa-balance-scale mr-2"></i>Saldo
                                    </th>
                                    <th style="padding: 15px; border-top: none; color: #4e73df; font-weight: 600;">
                            ...
                            <tbody>
                                @forelse ($uangTahunanHistori as $transaksi)
                                    <tr style="border-bottom: 1px solid #f0f0f0; transition: all 0.3s ease;" 
                                        ...
                                        <td style="padding: 15px; vertical-align: middle;">
                                            <div style="font-weight: 500;">{{ $transaksi->created_at->format('d M Y') }}</div>
                                            <small style="color: #6c757d;">{{ $transaksi->created_at->format('H:i') }}</small>
                                        </td>
                                        <td style="padding: 15px; vertical-align: middle;">
                                            @if($transaksi->debit > 0)
                                                <div style="display: inline-block; padding: 6px 12px; background: linear-gradient(135deg, #2ecc71 0%, #27ae60 100%); color: white; border-radius: 20px; font-size: 13px;">
                                                    <i class="fas fa-arrow-up mr-1"></i>Setoran
                                                </div>
                                            @else
                                                <div style="display: inline-block; padding: 6px 12px; background: linear-gradient(135deg, #e74c3c 0%, #c0392b 100%); color: white; border-radius: 20px; font-size: 13px;">
                                        ...
                                        <td style="padding: 15px; vertical-align: middle;">
                                            <div style="display: inline-flex; align-items: center; background: #f8f9fc; padding: 6px 12px; border-radius: 20px;">
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <div style="text-align: center; padding: 40px 20px;">
                                                <div style="background: #f8f9fc; width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px;">
                                                    <i class="fas fa-inbox" style="font-size: 30px; color: #b2bec3;"></i>
                                                </div>
                                                <h5 style="color: #2d3436; margin-bottom: 10px;">Belum Ada Transaksi</h5>
                                                <p style="color: #636e72; margin: 0;">Belum ada catatan transaksi uang kegiatan tahunan saat ini</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
