...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Edit Transaksi Tabungan</li>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">Form Edit Transaksi Tabungan</div>

                    <form method="POST" action="{{ route('tabungan.update', $tabungan->id) }}">
                        @csrf
                        @method('PUT')

                    {{-- bagian ini ada yang perlu diubah dari hosting --}}
                    <div class="form-group">
                        ...
                        <select class="form-control @error('id_siswa') is-invalid @enderror" 
                            ...
                            @foreach($siswaList as $siswa)
                                <option value="{{ $siswa->id }}" 
                                    {{ old('id_siswa', $tabungan->id_siswa) == $siswa->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('keterangan', $tabungan->keterangan) }}" required>
                            @error('keterangan')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
