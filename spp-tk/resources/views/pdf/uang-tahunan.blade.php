...
<head>
    <meta charset="utf-8">
    <title>Laporan Transaksi Uang Kegiatan Tahunan</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            Laporan Transaksi Uang Kegiatan Tahunan
        </div>
    </div>
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td>: {{ $uangTahunan->count() }}</td>
        </tr>
    </table>

    <p class="rincian-title">Daftar Transaksi Uang Kegiatan \Tahunan:</p>
    ...
    <table class="detail-table">
        ...
        <tbody>
            @foreach($uangTahunan as $transaksi)
            <tr>
